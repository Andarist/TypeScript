...
mixinAccessors1.d.ts(17,9): error TS2611: 'validationTarget' is defined as a property in class '{ readonly validationTarget: HTMLElement; } & BaseClass', but is overridden here in 'MyClass' as an accessor.
...
==== mixinAccessors1.d.ts (1 errors) ====
    ...
    declare class MyClass extends MyClass_base {
        get validationTarget(): HTMLElement;
            ~~~~~~~~~~~~~~~~
!!! error TS2611: 'validationTarget' is defined as a property in class '{ readonly validationTarget: HTMLElement; } & BaseClass', but is overridden here in 'MyClass' as an accessor.
    }
