...
mixinAccessors4.d.ts(16,9): error TS2611: 'myName' is defined as a property in class '{ readonly myName: string; } & A', but is overridden here in 'C' as an accessor.
...
==== mixinAccessors4.d.ts (1 errors) ====
    ...
    declare class C extends C_base {
        get myName(): string;
            ~~~~~~
!!! error TS2611: 'myName' is defined as a property in class '{ readonly myName: string; } & A', but is overridden here in 'C' as an accessor.
    }
