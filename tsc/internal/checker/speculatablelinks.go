...
func (l *ValueSymbolLinks) getResolvedType() *Type {
	return l.resolvedTypeCache.get(&l.speculatableSymbolLinks)
}

func (l *ValueSymbolLinks) setResolvedType(value *Type) {
	l.resolvedTypeCache.set(&l.speculatableSymbolLinks, value)
}

func (l *ValueSymbolLinks) getWriteType() *Type {
	return l.writeTypeCache.get(&l.speculatableSymbolLinks)
}

func (l *ValueSymbolLinks) setWriteType(value *Type) {
	l.writeTypeCache.set(&l.speculatableSymbolLinks, value)
}

func (l *ValueSymbolLinks) getNameType() *Type {
	return l.nameTypeCache.get(&l.speculatableSymbolLinks)
}

func (l *ValueSymbolLinks) setNameType(value *Type) {
	l.nameTypeCache.set(&l.speculatableSymbolLinks, value)
}

func (l *ValueSymbolLinks) getFunctionOrConstructorChecked() bool {
	return l.functionOrConstructorCheckedCache.get(&l.speculatableSymbolLinks)
}

func (l *ValueSymbolLinks) setFunctionOrConstructorChecked(value bool) {
	l.functionOrConstructorCheckedCache.set(&l.speculatableSymbolLinks, value)
}
