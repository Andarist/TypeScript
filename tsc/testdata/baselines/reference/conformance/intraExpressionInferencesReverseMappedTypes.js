...
const result1 = setup({
    actions: {
        first: (params, enqueue) => { },
        second: (params, enqueue) => { },
    },
    other: () => { },
});
const res18 = f12({
...
declare const res16: {
    earlierNonInferable: unknown;
    laterNonInferable: unknown;
    partiallyInferable: {
        value: string;
    };
    fullyInferable: number;
};
declare function f11<T extends {
    earlier: unknown;
}>(arg: {
    [K in keyof T]: {
        produce?: (n: string) => T[K];
...
declare function setup<TAction extends {
    first?: unknown;
} = {}>(arg: {
    actions?: {
