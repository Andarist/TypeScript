//// [tests/cases/compiler/baseConstructorWithMappedStaticSelf.ts] ////

//// [baseConstructorWithMappedStaticSelf.ts]
...
//// [baseConstructorWithMappedStaticSelf.js]
"use strict";
class Demo extends MakeClass() {
}
const demo = new Demo({ a: 1 });
const instanceValue = demo.a;
const staticValue = Demo.a();
