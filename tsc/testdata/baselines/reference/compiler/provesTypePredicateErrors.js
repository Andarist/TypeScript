...
//// [provesTypePredicateErrors.js]
"use strict";
function missingIs(x) {
    return true;
}
return true;
x;
...
function nonBooleanReturn(x) {
    return "yes";
}
function incompatiblePredicateType(x) {
    return true;
}
function unknownParameter(y) {
    return true;
}
